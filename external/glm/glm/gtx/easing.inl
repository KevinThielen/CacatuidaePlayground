...
namespace cac{
	...
	GLM_FUNC_QUALIFIER genType exponentialEaseIn(genType const& a)
	{
		...
		else
		{
			...
			return cac::pow(Two, Complementary * static_cast<genType>(10));
		}
	}
	...
	GLM_FUNC_QUALIFIER genType exponentialEaseOut(genType const& a)
	{
		...
		{
			return one<genType>() - cac::pow(static_cast<genType>(2), -static_cast<genType>(10) * a);
		}
	}
	...
	GLM_FUNC_QUALIFIER genType exponentialEaseInOut(genType const& a)
	{
		...
		if(a < static_cast<genType>(0.5))
			return static_cast<genType>(0.5) * cac::pow(static_cast<genType>(2), (static_cast<genType>(20) * a) - static_cast<genType>(10));
		else
			return -static_cast<genType>(0.5) * cac::pow(static_cast<genType>(2), (-static_cast<genType>(20) * a) + static_cast<genType>(10)) + one<genType>();
	}
	...
	GLM_FUNC_QUALIFIER genType elasticEaseIn(genType const& a)
	{
		...
		return std::sin(static_cast<genType>(13) * half_pi<genType>() * a) * cac::pow(static_cast<genType>(2), static_cast<genType>(10) * (a - one<genType>()));
	}
	...
	GLM_FUNC_QUALIFIER genType elasticEaseOut(genType const& a)
	{
		...
		return std::sin(-static_cast<genType>(13) * half_pi<genType>() * (a + one<genType>())) * cac::pow(static_cast<genType>(2), -static_cast<genType>(10) * a) + one<genType>();
	}
	...
	GLM_FUNC_QUALIFIER genType elasticEaseInOut(genType const& a)
	{
		...
		if(a < static_cast<genType>(0.5))
			return static_cast<genType>(0.5) * std::sin(static_cast<genType>(13) * half_pi<genType>() * (static_cast<genType>(2) * a)) * cac::pow(static_cast<genType>(2), static_cast<genType>(10) * ((static_cast<genType>(2) * a) - one<genType>()));
		else
			return static_cast<genType>(0.5) * (std::sin(-static_cast<genType>(13) * half_pi<genType>() * ((static_cast<genType>(2) * a - one<genType>()) + one<genType>())) * cac::pow(static_cast<genType>(2), -static_cast<genType>(10) * (static_cast<genType>(2) * a - one<genType>())) + static_cast<genType>(2));
	}
