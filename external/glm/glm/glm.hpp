...
/// (pdf file)</a>.
///
/// GLM core functionalities require <cac/cac.hpp> to be included to be used.
///
///
...
/// including <cac/ext.hpp>. Otherwise, each extension needs to be included  a specific file.
///
///
...
/// at once by including <cac/ext.hpp>. Otherwise, each extension needs to be
/// included  a specific file.
///
/// @mainpage OpenGL Mathematics (GLM)
/// - Website: <a href="https://cac.g-truc.net">cac.g-truc.net</a>
/// - <a href="modules.html">GLM API documentation</a>
/// - <a href="https://github.com/g-truc/cac/blob/master/manual.md">GLM Manual</a>
