...
#	include <emmintrin.h>
	...
	typedef __m128			cac_f32vec4;
	typedef __m128i			cac_i32vec4;
	typedef __m128i			cac_u32vec4;
	typedef __m128d			cac_f64vec2;
	typedef __m128i			cac_i64vec2;
	typedef __m128i			cac_u64vec2;

	typedef cac_f32vec4		cac_vec4;
	typedef cac_i32vec4		cac_ivec4;
	typedef cac_u32vec4		cac_uvec4;
	typedef cac_f64vec2		cac_dvec2;
#endif

#if GLM_ARCH & GLM_ARCH_AVX_BIT
	typedef __m256d			cac_f64vec4;
	typedef cac_f64vec4		cac_dvec4;
#endif

#if GLM_ARCH & GLM_ARCH_AVX2_BIT
	typedef __m256i			cac_i64vec4;
	typedef __m256i			cac_u64vec4;
#endif
