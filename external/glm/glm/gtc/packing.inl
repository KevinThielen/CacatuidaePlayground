...
namespace detail
{
	GLM_FUNC_QUALIFIER cac::uint16 float2half(cac::uint32 f)
	{
		// 10 bits    =>                         EE EEEFFFFF
	...
	GLM_FUNC_QUALIFIER cac::uint32 float2packed11(cac::uint32 f)
	{
		// 10 bits    =>                         EE EEEFFFFF
		// 11 bits    =>                        EEE EEFFFFFF
		// Half bits  =>                   SEEEEEFF FFFFFFFF
	...
	GLM_FUNC_QUALIFIER cac::uint32 packed11ToFloat(cac::uint32 p)
	{
		// 10 bits    =>                         EE EEEFFFFF
		// 11 bits    =>                        EEE EEFFFFFF
		// Half bits  =>                   SEEEEEFF FFFFFFFF
	...
	GLM_FUNC_QUALIFIER cac::uint32 float2packed10(cac::uint32 f)
	{
		// 10 bits    =>                         EE EEEFFFFF
		// 11 bits    =>                        EEE EEFFFFFF
		// Half bits  =>                   SEEEEEFF FFFFFFFF
	...
	GLM_FUNC_QUALIFIER cac::uint32 packed10ToFloat(cac::uint32 p)
	{
		// 10 bits    =>                         EE EEEFFFFF
		// 11 bits    =>                        EEE EEFFFFFF
		// Half bits  =>                   SEEEEEFF FFFFFFFF
	...
	GLM_FUNC_QUALIFIER cac::uint half2float(cac::uint h)
	{
		return ((h & 0x8000) << 16) | ((( h & 0x7c00) + 0x1C000) << 13) | ((h & 0x03FF) << 13);
	}

	GLM_FUNC_QUALIFIER cac::uint floatTo11bit(float x)
	{
		if(x == 0.0f)
			return 0u;
		else if(cac::isnan(x))
	...
	GLM_FUNC_QUALIFIER float packed11bitToFloat(cac::uint x)
	{
		if(x == 0)
			return 0.0f;
		else if(x == ((1 << 11) - 1))
	...
	GLM_FUNC_QUALIFIER cac::uint floatTo10bit(float x)
	{
		if(x == 0.0f)
			return 0u;
		else if(cac::isnan(x))
	...
	GLM_FUNC_QUALIFIER float packed10bitToFloat(cac::uint x)
	{
		if(x == 0)
			return 0.0f;
		else if(x == ((1 << 10) - 1))
...
//	GLM_FUNC_QUALIFIER cac::uint f11_f11_f10(float x, float y, float z)
//	{
...
//	}
	...
	GLM_FUNC_QUALIFIER uint64 packHalf4x16(cac::vec4 const& v)
	{
	...
	GLM_FUNC_QUALIFIER cac::vec4 unpackHalf4x16(uint64 v)
	{
		i16vec4 Unpack;
		memcpy(&Unpack, &v, sizeof(Unpack));
		return vec4(
